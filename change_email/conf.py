...
"""
    ...
    EMAIL_CHANGE_HTML_EMAIL_TEMPLATE = 'change_email/emailchange_email.html'
    EMAIL_CHANGE_SUBJECT_EMAIL_TEMPLATE = 'change_email/emailchange_subject.txt'
    EMAIL_CHANGE_TIMEOUT_DAYS = 7
    EMAIL_CHANGE_TXT_EMAIL_TEMPLATE = 'change_email/emailchange_email.txt'
